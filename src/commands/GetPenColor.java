...
public class GetPenColor extends BasicCommand {

	public GetPenColor(String name, ObservableList<Variable> vars, ObservableList<UserCommand> methods) {
	...
	public String executeCommand(TurtleDisplay td, CommandList commands, Integer id)
		...
		return td.getColorPen(id).toString();
	}
