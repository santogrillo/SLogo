...
public class GetShape extends BasicCommand {

	public GetShape(String name, ObservableList<Variable> vars, ObservableList<UserCommand> methods) {
	...
	public String executeCommand(TurtleDisplay td, CommandList commands, Integer id)
		...
		return Double.toString(td.getShape(id));
	}
