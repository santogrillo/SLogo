...
public class ArcTangent extends BasicCommand {
	public ArcTangent(String name, ObservableList<Variable> vars, ObservableList<UserCommand> methods) {
	...
	public String executeCommand(TurtleDisplay td, CommandList commands, Integer id) throws NumberFormatException, ArgumentCountException, MissingBracketException, InvalidArgumentException, InvalidCommandException {
		double arctan = Math.atan(Double.parseDouble(nextCommandValue(td, commands, id)));
		return Double.toString(arctan);
	}	
}